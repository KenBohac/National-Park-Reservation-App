...
INSERT INTO campground VALUES (@testParkId, 'LaLa Land', 5, 11, 25.00);
...
SELECT @testParkId as testParkId, @campgroundId as campgroundId, @siteId as siteId, @reservationId as reservationId;
